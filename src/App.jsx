...
FINAL SCORE
${homeTeam}: ${homeGoals}-${homePoints.toString().padStart(2, '0')}
${awayTeam}: ${awayGoals}-${awayPoints.toString().padStart(2, '0')}

STATISTICS
Total Events: ${stats.totalEvents}
Goals: ${stats.homeGoals} - ${stats.awayGoals}
Points: ${stats.homePoints} - ${stats.awayPoints}
Fouls: ${stats.homeFouls} - ${stats.awayFouls}
Wides: ${stats.homeWides} - ${stats.awayWides}

EVENTS TIMELINE
${events.map(e => `${formatTime(e.timestamp)} - ${e.team === 'home' ? homeTeam : awayTeam} - ${e.label}${e.notes ? ' (' + e.notes + ')' : ''}`).join('\n')}
        `;
        ...
        a.href = url;
        a.download = `${homeTeam}-vs-${awayTeam}-${Date.now()}.txt`;
        a.click();
    };
                            ...
                            <div style={{background: 'rgba(255,255,255,0.1)', borderRadius: '12px', padding: '32px'}}>
                                ...
                                <div style={{display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px'}}>
                                    <div>
                                        ...
                                        <div style={{height: '200px', background: 'rgba(0,0,0,0.2)', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'rgba(255,255,255,0.6)'}}>Chart Placeholder</div>
                                    </div>
                                    <div>
