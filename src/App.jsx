...
// Landing Page - COMPLETE from original
function LandingPage({ setView }) {
    ...
    return (
        <div>
                    ...
                    <div className="accordion-container">
                        ...
                        <div className="accordion-item">
                            <button className="accordion-header" onClick={() => setAccordion2(!accordion2)}>
                                <h3 className="accordion-title">TAGGING & ANALYSIS</h3>
                                <span className={`accordion-icon ${accordion2 ? 'active' : ''}`}>+</span>
                            </button>
                            <div className={`accordion-content ${accordion2 ? 'active' : ''}`}>
                                <div className="accordion-content-inner">
                                    <p className="body-md mb-medium">
                                        Mark key moments - goals, points, turnovers, defensive plays. Build a complete picture of every match with GAA-specific metrics.
                                    </p>
                                    <p className="body-md mb-small">Track Everything:</p>
                                    <ul style={{listStyle: 'none', padding: 0, margin: 0}}>
                                        <li className="body-md mb-small" style={{paddingLeft: '24px', position: 'relative'}}>
                                            <span style={{position: 'absolute', left: 0}}>•</span>
                                            Goals, points, and scoring chances
                                        </li>
                                        <li className="body-md mb-small" style={{paddingLeft: '24px', position: 'relative'}}>
                                            <span style={{position: 'absolute', left: 0}}>•</span>
                        ...
                        <div className="accordion-item">
                            <button className="accordion-header" onClick={() => setAccordion3(!accordion3)}>
                                <h3 className="accordion-title">REPORTS & SHARING</h3>
                                <span className={`accordion-icon ${accordion3 ? 'active' : ''}`}>+</span>
                            </button>
                            <div className={`accordion-content ${accordion3 ? 'active' : ''}`}>
                                <div className="accordion-content-inner">
                                    <p className="body-md mb-medium">
                                        Generate professional match reports and share insights with your coaching team. Export data for deeper analysis or presentations.
                                    </p>
                                    <p className="body-md mb-small">Share Your Way:</p>
                                    <ul style={{listStyle: 'none', padding: 0, margin: 0}}>
                                        <li className="body-md mb-small" style={{paddingLeft: '24px', position: 'relative'}}>
                                            <span style={{position: 'absolute', left: 0}}>•</span>
                                            PDF match reports
            ...
            {/* Footer */}
            <footer style={{background: '#000', color: 'white', padding: '48px 24px', textAlign: 'center'}}>
                <div style={{maxWidth: '1200px', margin: '0 auto'}}>
                    <div style={{marginBottom: '32px'}}>
                        ...
                        <div style={{fontSize: '24px', fontWeight: '900', marginTop: '16px'}}>PÁIRCPRO</div>
                    </div>
                    <div style={{display: 'flex', justifyContent: 'center', gap: '32px', marginBottom: '32px'}}>
                        <a href="#" onClick={(e) => {e.preventDefault(); setView('pricing');}} style={{color: 'rgba(255,255,255,0.7)', textDecoration: 'none', fontSize: '14px'}}>Pricing</a>
                ...
                <div style={{maxWidth: '600px', margin: '0 auto'}}>
                    {sent ? (
                        <div style={{textAlign: 'center', padding: '80px 0'}}>
                            ...
                            <h2 style={{fontSize: '32px', fontWeight: '800', marginBottom: '16px'}}>MESSAGE SENT!</h2>
                        ...
                        <>
                            <h1 className="display-lg uppercase mb-medium text-center">BOOK YOUR DEMO</h1>
                            <p className="body-lg mb-xlarge text-center" style={{color: 'var(--gray-mid)'}}>
                                See PáircPro in action. We'll walk you through the platform and answer your questions.
                            </p>
