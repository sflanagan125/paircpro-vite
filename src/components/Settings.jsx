...
function Settings({ user, setView, setActivePage, supabase }) {
    ...
    const deleteAccount = async () => {
        ...
        alert('Account deletion requires backend implementation with email confirmation');
    };
                ...
                <div style={{background: 'rgba(255,255,255,0.1)', borderRadius: '12px', padding: '32px', marginBottom: '24px'}}>
                    ...
                    <div style={{marginBottom: '20px'}}>
                        ...
                        <div style={{display: 'flex', alignItems: 'center', gap: '16px'}}>
                            ...
                            <button onClick={() => alert('Photo upload requires file picker implementation')} style={{padding: '12px 24px', background: 'rgba(255,255,255,0.2)', border: 'none', color: 'white', borderRadius: '8px', cursor: 'pointer', fontWeight: '600', fontSize: '14px', fontFamily: 'inherit'}}>
                                Change Photo
                            </button>
                        </div>
                    </div>
                    ...
                    <div style={{marginBottom: '20px'}}>
                        ...
                        <input type="text" value={fullName} onChange={(e) => setFullName(e.target.value)} placeholder="Enter your full name" style={{width: '100%', padding: '12px', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.3)', background: 'rgba(255,255,255,0.05)', color: 'white', fontSize: '16px'}} />
                    </div>
                    ...
                    <div style={{marginBottom: '20px'}}>
                        ...
                        <textarea value={bio} onChange={(e) => setBio(e.target.value)} placeholder="Tell us about yourself" rows="4" style={{width: '100%', padding: '12px', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.3)', background: 'rgba(255,255,255,0.05)', color: 'white', fontSize: '16px', fontFamily: 'inherit', resize: 'vertical'}}></textarea>
                    </div>
                    
                    <button onClick={saveProfile} style={{padding: '12px 24px', background: 'white', border: 'none', color: '#00833E', borderRadius: '8px', cursor: 'pointer', fontWeight: '700', fontSize: '14px', fontFamily: 'inherit'}}>
                        Save Profile
                    </button>
                </div>
                ...
                <div style={{background: 'rgba(255,255,255,0.1)', borderRadius: '12px', padding: '32px', marginBottom: '24px'}}>
                    ...
                    <div style={{marginBottom: '24px'}}>
                        ...
                        <div style={{marginBottom: '12px'}}>
                            <input type="password" value={currentPassword} onChange={(e) => setCurrentPassword(e.target.value)} placeholder="Current password" style={{width: '100%', padding: '12px', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.3)', background: 'rgba(255,255,255,0.05)', color: 'white', fontSize: '14px', marginBottom: '8px'}} />
                            <input type="password" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} placeholder="New password" style={{width: '100%', padding: '12px', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.3)', background: 'rgba(255,255,255,0.05)', color: 'white', fontSize: '14px', marginBottom: '8px'}} />
                            <input type="password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} placeholder="Confirm new password" style={{width: '100%', padding: '12px', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.3)', background: 'rgba(255,255,255,0.05)', color: 'white', fontSize: '14px'}} />
                        </div>
                        <button onClick={updatePassword} style={{padding: '10px 20px', background: 'rgba(255,255,255,0.2)', border: 'none', color: 'white', borderRadius: '8px', cursor: 'pointer', fontWeight: '600', fontSize: '14px', fontFamily: 'inherit'}}>
                            Update Password
                        </button>
                    </div>
                    ...
                    <div style={{borderTop: '1px solid rgba(255,255,255,0.2)', paddingTop: '24px', marginTop: '24px'}}>
                        ...
                        <button onClick={deleteAccount} style={{padding: '12px 24px', background: 'rgba(220,38,38,0.3)', border: '1px solid #DC2626', color: 'white', borderRadius: '8px', cursor: 'pointer', fontWeight: '700', fontSize: '14px', fontFamily: 'inherit'}}>
                            Delete Account
                        </button>
                    </div>
                </div>
